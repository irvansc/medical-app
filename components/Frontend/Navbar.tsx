...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white border-b border-gray-400/20 z-50">
      <nav
        aria-label="Global"
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-200">
              ...
              <div className="py-6">
                <a
                  href="#"
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-800 hover:bg-gray-100"
                >
                  Log in
                </a>
              </div>
